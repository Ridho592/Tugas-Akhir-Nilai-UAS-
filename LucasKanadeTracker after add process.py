...
# Fungsi tambahan untuk resize gambar
...
# Parameter deteksi dan pelacakan
...
while True:
    ...
    frame = image_resize(frame, height=500)
    ...
    # Menampilkan frame grayscale
    cv2.imshow("Grayscale Frame", curr_gray_frame)
    ...
    cv2.imshow("Output Tracking", output)
